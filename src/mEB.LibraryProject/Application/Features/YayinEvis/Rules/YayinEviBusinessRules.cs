using Application.Features.YayinEvis.Constants;
...
namespace Application.Features.YayinEvis.Rules;
...
public class YayinEviBusinessRules : BaseBusinessRules
{
    ...
    {
        string message = await _localizationService.GetLocalizedAsync(messageKey, YayinEvisBusinessMessages.SectionName);
    ...
    {
        if (yayinEvi == null)
            await throwBusinessException(YayinEvisBusinessMessages.YayinEviNotExists);
    }
