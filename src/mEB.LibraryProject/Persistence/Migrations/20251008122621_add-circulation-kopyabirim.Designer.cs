...
namespace Persistence.Migrations
{
    ...
    [Migration("20251008122621_add-circulation-kopyabirim")]
    partial class addcirculationkopyabirim
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Odunc", b =>
                {
                    ...
                    b.Property<Guid?>("KopyaBirimId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("KopyaBirimId");
            ...
            modelBuilder.Entity("Domain.Entities.Odunc", b =>
                {
                    b.HasOne("Domain.Entities.KopyaBirim", "KopyaBirim")
                        .WithMany()
                        .HasForeignKey("KopyaBirimId")
                        .OnDelete(DeleteBehavior.Restrict);
